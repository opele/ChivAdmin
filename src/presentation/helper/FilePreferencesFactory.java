...
/**
 * PreferencesFactory implementation that stores the preferences in a user-defined file. To use it, set the system property <tt>java.util.prefs.PreferencesFactory</tt> to
...
public class FilePreferencesFactory implements PreferencesFactory {
	...
	public static final String SYSTEM_PROPERTY_FILE = "FilePreferencesFactory.file";
	...
	public static void main(String[] args) throws BackingStoreException {
		...
		System.setProperty(SYSTEM_PROPERTY_FILE, "ChivAdminConfig.txt");
